/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: 47f237e817971eaac5faca99b32c8be3)
...
interface __BaseEnv_CloudflareBindings {
	...
	SUPABASE_URL: "https://mbscfzccmomwqdybnlbq.supabase.co";
	TURNSTILE_ALLOWED_HOSTNAMES: "kenarhinlabs.com,www.kenarhinlabs.com";
	CLOUDFLARE_EMAIL_WEBHOOK_SECRET: string;
	EMAIL_REPLY_TOKEN_SECRET: string;
	INTERNAL_QUEUE_WEBHOOK_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_SITE_URL" | "ALLOWED_ORIGINS" | "EMAIL_ATTACHMENT_BUCKET_NAME" | "EMAIL_FROM_NAME" | "ENVIRONMENT" | "HEALTH_CHECK_TIMEOUT_MS" | "SUPABASE_JWT_AUDIENCE" | "SUPABASE_URL" | "TURNSTILE_ALLOWED_HOSTNAMES" | "CLOUDFLARE_EMAIL_WEBHOOK_SECRET" | "EMAIL_REPLY_TOKEN_SECRET" | "INTERNAL_QUEUE_WEBHOOK_SECRET" | "SUPABASE_WEBHOOK_SECRET" | "TURNSTILE_SECRET_KEY">> {}
}
