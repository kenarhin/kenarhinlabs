/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: 57b8e5096b01c197a6691fac0e693254)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "ENVIRONMENT" | "HEALTH_CHECK_TIMEOUT_MS" | "SUPABASE_JWT_AUDIENCE" | "SUPABASE_URL" | "CLOUDFLARE_EMAIL_WEBHOOK_SECRET" | "INTERNAL_QUEUE_WEBHOOK_SECRET" | "SUPABASE_WEBHOOK_SECRET">> {}
}
